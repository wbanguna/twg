...
// Example User model. Typically wouldn't be defined here
type User struct {
	ID    int
	Name  string
	Email string
...
// UserStore is used to interact with our user stroe.
...
// Find will retrieve a user with provided ID or return ErrNotFound
// if user not found. Other errors wrapped with context.
